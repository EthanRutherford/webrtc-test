...
class Game extends Component {
	...
	createMessage(frame) {
		const bodies = {};
		for (const bodyId of Object.keys(this.physicsState.bodies)) {
			const id = this.physicsState.bodies[bodyId];
			bodies[bodyId] = new BodyState(
				this.physicsState.solver.bodyMap[id],
			);
		}
